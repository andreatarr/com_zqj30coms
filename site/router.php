...
/**
 * Build the route for the zqj30coms component
 *
 * @param	array	An array of URL arguments
 *
 * @return	array	The URL arguments to use to assemble the subsequent URL.
 */
function Zqj30comsBuildRoute(&$query)
{
	$segments = array();
	...
	if (isset($view) and ($view == 'category' or $view == 'zqj30coms' )) {
		if ($mId != intval($query['id']) || $mView != $view) {
			if ($view == 'zqj30com' && isset($query['catid'])) {
				$catid = $query['catid'];
			}
 ...
 */
function Zqj30comsParseRoute($segments)
{
	$vars = array();
	...
	$category = JCategories::getInstance('Zqj30coms')->get($id);
